(function($) {
 ...
 var dzChartlist = function(){
    ...
    //       series: [{
    //       name: 'series1',
    //       data: [120,345,900,800, 440, 360, 510, 420, 680, 400,200,700]
    //     }, {
    //       name: 'series2',
    //       data: [900,345,680,210, 320, 130, 320, 150, 310, 120,620,320]
    //     }],
    //       chart: {
    //       height: 350,
    //       type: 'area',
	...
	// 	xaxis: {
    //       type: 'month',
    //       categories: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "Dec"]
    //     },
	// 	colors: ['#3B4CB8','#37D159'],
	// 	fill: {
	// 		colors: ['#3B4CB8','#37D159'],
    ...
    //     var chart = new ApexCharts(document.querySelector("#chartBars"), options);
    //     chart.render();
	// }
